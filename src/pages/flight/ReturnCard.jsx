...
export const ReturnCard = React.memo(function ReturnCard(props) {
  ...
  let flight2=""
        ...
        if(props.flight?.itineraries[0].segments.length > 1){
            flight1=    <Card className={styles.card} elevation={0}>
            ...
            <div className={cx(styles.right, styles.moveRight)}>
              ...
              <div className={styles.path}>
                ...
                <span className={styles.flight}>Direct</span>
      
              </div>
              <div className={styles.label}>
                <h2 className={styles.heading}>{props.flight?.itineraries[0].segments[0].arrival.iataCode}</h2>
                <p className={styles.subheader}>{Moment(props.flight?.itineraries[0].segments[0].arrival.at).format('HH:mm')}</p>
              </div>
            </div>
        ...
        if(props.flight?.itineraries[1].segments.length > 1){
            flight2=    <Card className={styles.card} elevation={0}>
            <div className={cx(styles.left, styles.moveLeft)}>
            ...
            <div className={cx(styles.right, styles.moveRight)}>
              <div className={styles.label}>
                <h2 className={styles.heading}>{props.flight?.itineraries[1].segments[0].departure.iataCode}</h2>
                <p className={styles.subheader}>{Moment(props.flight?.itineraries[1].segments[0].departure.at).format('HH:mm')}</p>
              </div>
              <div className={styles.path}>
                <div className={styles.line}>
                  <AirplanemodeActive className={styles.plane} />
                </div>
                <span className={styles.flight}>Stop at {props.flight?.itineraries[1].segments[0].arrival.iataCode} {Moment(props.flight?.itineraries[1].segments[0].arrival.at).format('HH:mm')}</span>
      
              </div>
              <div className={styles.label}>
                <h2 className={styles.heading}>{props.flight?.itineraries[1].segments[1].arrival.iataCode}</h2>
                <p className={styles.subheader}>{Moment(props.flight?.itineraries[1].segments[1].arrival.at).format('HH:mm')}</p>
              </div>
            </div>
            ...
            <div className={cx(styles.right, styles.moveRight)}>
              ...
              <div className={styles.label}>
                <h2 className={styles.heading}>{props.flight?.itineraries[1].segments[0].arrival.iataCode}</h2>
                <p className={styles.subheader}>{Moment(props.flight?.itineraries[1].segments[0].arrival.at).format('HH:mm')}</p>
              </div>
            </div>
